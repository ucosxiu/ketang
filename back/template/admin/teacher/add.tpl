                            ...
                            <form class="layui-form" action="" method="post" onsubmit="return false">
                                <div class="layui-form-item layui-form-text">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="teacher_name" lay-verify="required" autocomplete="off" class="layui-input" value="">
                                    </div>
                                </div>
                                <div class="layui-form-item layui-form-text layui-col-lg6">
                                    <label class="layui-form-label">{:lang('teacher_pic')}</label>
                                    <div class="layui-inline">
                                        <input type="text" name="teacher_pic" lay-verify="required" class="layui-input" id="teacher_pic" readonly>
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <textarea id="demo" name="teacher_intro" class="layui-textarea"></textarea>
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        ...
                                        <input type="radio" name="teacher_state" value="0" title="{:lang('close')}">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <div class="layui-input-block">
