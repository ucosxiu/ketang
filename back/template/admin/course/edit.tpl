                        ...
                        <div class="layui-form">
                            <form class="layui-form" action="" method="post" onsubmit="return false">
                                ...
                                <div class="layui-form-item layui-form-text">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="goods_name" lay-verify="required" autocomplete="off" class="layui-input" value="{$course.goods_name}">
                                    </div>
                                </div>
                                <div class="layui-form-item layui-form-text">
                                    <label class="layui-form-label">{:lang('goods_type')}</label>
                                    <div class="layui-input-inline readonly">
                                        <input type="radio" name="goods_type" value="0" title="{:lang('baoming')}"  checked="" readonly>
                                        {php}$checked = $course['goods_type'] ? 'checked' : '';{/php}
                                        <input type="radio" name="goods_type" value="1" title="{:lang('video')}" {$checked}>
                                    </div>
                                    <div class="layui-form-mid layui-word-aux red">不能修改</div>
                                </div>
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-inline">
                                        ...
                                        {php}$checked1 = $course['is_free'] == 1 ? '' : 'checked';{/php}
                                        <input type="radio" name="is_free" value="0" title="{:lang('charge')}" lay-filter="is_free" {$checked1}>
                                    </div>
                                    {if $course['is_free']}
                                    ...
                                    {else/}
                                        <div class="layui-inline goods_price">
                                            <input type="number" name="goods_price" autocomplete="off" class="layui-input" value="{$course.goods_price}" id="goods_price" lay-verify="required">
                                ...
                                <div class="layui-form-item layui-form-text layui-col-lg6">
                                    ...
                                    <div class="layui-inline">
                                        <input type="text" name="goods_pic" lay-verify="required" class="layui-input" id="goods_pic" value="{$course.goods_pic}" readonly>
                                ...
                                <div class="layui-form-item layui-form-text layui-col-lg6">
                                    ...
                                    <div class="layui-input-block">
                                        <div class="layui-upload-list">
                                            <img class="layui-upload-img" id="demo1" src="__ROOT__/{$course.goods_pic}">
                                            <p id="demoText"></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <textarea name="goods_intro" id="goods_intro" class="editor" lay-verify="goods_intro">{:$course.goods_intro}</textarea>
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        ...
                                        {php}$checked2 = $course['goods_state'] == 1 ? '' : 'checked';{/php}
                                        <input type="radio" name="goods_state" value="0" title="{:lang('close')}" {$checked2}>
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <div class="layui-input-block">
                        ...
                        <script>
                            $(function(){
                                layui.config({
                                    ...
                                    $teacheres = JSON.parse('{php}echo json_encode($course->teacherids);{/php}')
                                    var init = [];
                                    for (var i in $teacheres) {
                                        init.push($teacheres[i].teacher_id)
                                    }
