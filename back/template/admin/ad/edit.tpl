                        ...
                        <div class="layui-form ">
                            <form class="layui-form" action="" method="post" onsubmit="return false">
                                <div class="layui-form-item layui-form-text layui-col-lg6">
                                    ...
                                    <div class="layui-input-block">
                                        <select name="position_id" id='position_id' class="form-control" model="select" lay-filter="position_id">
                                            ...
                                            <option value="{$item.position_id}" {if condition="$item.position_id eq $ad.position_id"}selected{/if}>{$item.position_name}</option>
                                            {/foreach}
                                        </select>
                                    </div>
                                </div>
                                <div class="layui-form-item layui-form-text layui-col-lg6">
                                    ...
                                    <div class="layui-input-block">
                                        <div class="layui-upload">
                                            ...
                                            <div class="show" id="show" {empty name="ad.ad_img"}style="display: none"{/empty}>
                                                <i style="font-size: 30px" class="layui-picture layui-icon layui-icon-picture" {notempty name="ad.ad_img"}data-src="__ROOT__/{$ad.ad_img}"{/notempty}></i>
                                                <input type="hidden" name="ad_img" value="{$ad.ad_img}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="layui-form-item layui-form-text layui-col-lg6">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="ad_link" lay-verify="" autocomplete="off" class="layui-input" value="{$ad.ad_link}">
                                    </div>
                                </div>
                                <div class="layui-form-item layui-form-text layui-col-lg6">
                                    <label class="layui-form-label">{:lang('ad_title')}</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="ad_title" lay-verify="" autocomplete="off" class="layui-input" value="{$ad.ad_title}">
                                    </div>
                                </div>
                                <div class="layui-form-item layui-form-text layui-col-lg6">
                                    <label class="layui-form-label">{:lang('ad_stitle')}</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="ad_stitle" lay-verify="" autocomplete="off" class="layui-input" value="{$ad.ad_stitle}">
                                    </div>
                                </div>
                                <div class="layui-form-item layui-form-text layui-col-lg6">
                                    ...
                                    <div class="layui-input-block">
                                        ...
                                        {php}$checked = $ad->status ? '' : 'checked';{/php}
