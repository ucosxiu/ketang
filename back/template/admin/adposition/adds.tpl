                            ...
                            <form class="layui-form" action="" method="post" onsubmit="return false">
                                <div class="layui-form-item layui-form-text layui-col-lg6">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="position_name" lay-verify="required" autocomplete="off" class="layui-input" value="">
                                    </div>
                                </div>
                                <div class="layui-form-item layui-form-text layui-col-lg6">
                                    <label class="layui-form-label">{:lang('ad_width')}</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="ad_width" lay-verify="required" autocomplete="off" class="layui-input" value="">
                                    </div>
                                </div>
                                <div class="layui-form-item layui-form-text layui-col-lg6">
                                    <label class="layui-form-label">{:lang('ad_height')}</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="ad_height" lay-verify="required" autocomplete="off" class="layui-input" value="">
                                    </div>
                                </div>
                                <div class="layui-form-item layui-form-text layui-col-lg6">
                                    <label class="layui-form-label">{:lang('position_model')}</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="position_model" lay-verify="required" autocomplete="off" class="layui-input" value="">
                                    </div>
                                </div>
                                <div class="layui-form-item layui-form-text layui-col-lg6">
                                    <label class="layui-form-label">{:lang('position_desc')}</label>
                                    <div class="layui-input-block">
                                        <textarea name="position_desc" id="position_desc"  class="layui-textarea" ></textarea>
                                    </div>
                                </div>
