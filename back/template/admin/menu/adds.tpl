                        ...
                        <div class="layui-form">
                            <form class="layui-form" action="" method="post" onsubmit="return false">
                                ...
                                <div class="layui-form-item layui-form-text">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="menuname" lay-verify="menuname" autocomplete="off" class="layui-input" value="">
                                    </div>
                                </div>
                                <div class="layui-form-item layui-form-text">
                                    <label class="layui-form-label">{:lang('module')}</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="m" lay-verify="m" autocomplete="off" class="layui-input" value="">
                                    </div>
                                </div>
                                <div class="layui-form-item layui-form-text">
                                    <label class="layui-form-label">{:lang('controller')}</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="c" lay-verify="c" autocomplete="off" class="layui-input" value="">
                                    </div>
                                </div>
                                <div class="layui-form-item layui-form-text">
                                    <label class="layui-form-label">{:lang('action')}</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="a" lay-verify="a" autocomplete="off" class="layui-input" value="">
                                    </div>
                                </div>
                                <div class="layui-form-item layui-form-text">
                                    <label class="layui-form-label">{:lang('parameter')}</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="parameter" lay-verify="parameter" autocomplete="off" class="layui-input" value="">
                                    </div>
                                </div>
                                <div class="layui-form-item layui-form-text">
                                    <label class="layui-form-label">{:lang('icon')}</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="icon" lay-verify="icon" autocomplete="off" class="layui-input" value="">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <select name="type" class="form-control">
                                            ...
                                            <option value="0">{:lang('type0')}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="layui-form-item">
