          ...
          m = function() {
            ...
            return ! r && c.sortKey ? c.sort(c.sortKey.field, c.sortKey.sort, !0) : (layui.each(u,
              function(a, l) {
                ...
                }), c.config.treetable != undefined && c.config.treetable ? (f.push('<tr data-index="' + a + '" data-parentid="' + l.parentid + '">' + o.join("") + "</tr>"), p.push('<tr data-index="' + a + '" data-parentid="' + l.parentid + '">' + u.join("") + "</tr>"), v.push('<tr data-index="' + a + '" data-parentid="' + l.parentid + '">' + h.join("") + "</tr>")): f.push('<tr data-index="' + a + '">' + o.join("") + "</tr>"), p.push('<tr data-index="' + a + '">' + u.join("") + "</tr>"), v.push('<tr data-index="' + a + '">' + h.join("") + "</tr>"))
