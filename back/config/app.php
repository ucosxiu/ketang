...
if (is_dir($configPath . 'extra')) {
    $dir = $configPath . 'extra' . DIRECTORY_SEPARATOR;
    $files = isset($dir) ? scandir($dir) : [];
    $configExt    = App::getConfigExt();
    foreach ($files as $file) {
        if ('.' . pathinfo($file, PATHINFO_EXTENSION) === $configExt) {
            $lang[pathinfo($file, PATHINFO_FILENAME)] = include_once($dir . $file);
        }
    }
}
